...
Достигнутая производительность - 7.22 мСек на наблюдение, условиям ограничения соответствует. Для дальнейшего повышения качества распознавания положения пальцев можно попробовать выделить предсказание положения одного самого проблемного пальца в отдельную модель и перейти к двухмодельной архитектуре. 
